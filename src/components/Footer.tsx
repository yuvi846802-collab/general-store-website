        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-12">
          ...
          <div className="col-span-1 md:col-span-2 lg:col-span-1">
            ...
            <div className="flex gap-4">
              <a href="https://instagram.com/hakeem_store" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-card/10 flex items-center justify-center hover:bg-primary transition-colors text-white">
                <FaInstagram size={18} />
              </a>
              <a href="https://wa.me/917896541230" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-full bg-card/10 flex items-center justify-center hover:bg-[#25D366] transition-colors text-white">
                <FaWhatsapp size={18} />
              </a>
            </div>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li><a href="#products" className="text-gray-400 hover:text-secondary transition-colors">Products</a></li>
              <li><a href="#why-us" className="text-gray-400 hover:text-secondary transition-colors">Why Choose Us</a></li>
              <li><a href="#reviews" className="text-gray-400 hover:text-secondary transition-colors">Customer Reviews</a></li>
            </ul>
          </div>
          ...
          <div className="col-span-1 md:col-span-2 lg:col-span-2">
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-center gap-3 text-gray-400">
                ...
                <a href="tel:+917896541230" className="hover:text-white transition-colors">+91 7896541230</a>
              </li>
            </ul>
          </div>
